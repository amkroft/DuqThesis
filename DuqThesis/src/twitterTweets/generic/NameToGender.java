...
public class NameToGender {
	...
	private void readFiles(){
		...
		try {
			...
			System.err.println("Could not find file males.txt.  Males list will be empty.");
			e.printStackTrace();
		}
		...
		try {
			...
			System.err.println("Could not find file females.txt.  Females list will be empty.");
			e.printStackTrace();
		}
	...
	public char nameToGender(String name){
